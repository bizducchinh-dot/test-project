...
export const okrV1ProgressRecordCreate = {
  ...
  schema: {
    data: z.object({
            ...
            .array(
              z.object({
                ...
                paragraph: z
                  .object({
                    ...
                    elements: z
                      .array(
                        z.object({
                          type: z.enum(['textRun', 'docsLink', 'person']).optional(),
                          textRun: z
                            .object({
                              ...
                              style: z
                                .object({
                                  ...
                                  backColor: z.object({ red: z.number().optional(), green: z.number().optional(), blue: z.number().optional(), alpha: z.number().optional() }).optional(),
                                  textColor: z.object({ red: z.number().optional(), green: z.number().optional(), blue: z.number().optional(), alpha: z.number().optional() }).optional(),
                                  link: z.object({ url: z.string().optional() }).optional(),
                                })
                                .optional(),
                            })
                            .optional(),
                          docsLink: z.object({ url: z.string().optional(), title: z.string().optional() }).optional(),
                          person: z.object({ openId: z.string().optional() }).optional(),
                        }),
                      )
                      .optional(),
                  })
                ...
                gallery: z
                  .object({
                    imageList: z
                      .array(z.object({ fileToken: z.string().optional(), src: z.string().optional(), width: z.number().optional(), height: z.number().optional() }))
                      .optional(),
                  })
                  .optional(),
              }),
      ...
      source_url_pc: z.string().optional(),
      source_url_mobile: z.string().optional(),
    }),
    params: z.object({ user_id_type: z.enum(['open_id', 'union_id', 'user_id']).optional() }).optional(),
...
export const okrV1ProgressRecordGet = {
  ...
  schema: {
    params: z.object({ user_id_type: z.enum(['open_id', 'union_id', 'user_id']).optional() }).optional(),
    path: z.object({ progress_id: z.string().optional() }).optional(),
    useUAT: z.boolean().optional(),
  },
};
    ...
    data: z.object({
      content: z.object({
        blocks: z.array(z.object({
          type: z.enum(['paragraph', 'gallery']).optional(),
          paragraph: z.object({
            style: z.object({ list: z.object({ type: z.enum(['number', 'bullet', 'checkBox', 'checkedBox', 'indent']).optional(), indentLevel: z.number().optional(), number: z.number().optional() }).optional() }).optional(),
            elements: z.array(z.object({
              type: z.enum(['textRun', 'docsLink', 'person']).optional(),
              textRun: z.object({ text: z.string().optional(), style: z.object({ bold: z.boolean().optional(), strikeThrough: z.boolean().optional(), backColor: z.object({ red: z.number().optional(), green: z.number().optional(), blue: z.number().optional(), alpha: z.number().optional() }).optional(), textColor: z.object({ red: z.number().optional(), green: z.number().optional(), blue: z.number().optional(), alpha: z.number().optional() }).optional(), link: z.object({ url: z.string().optional() }).optional() }).optional() }).optional(),
              docsLink: z.object({ url: z.string().optional(), title: z.string().optional() }).optional(),
              person: z.object({ openId: z.string().optional() }).optional(),
            })).optional(),
          }).optional(),
          gallery: z.object({ imageList: z.array(z.object({ fileToken: z.string().optional(), src: z.string().optional(), width: z.number().optional(), height: z.number().optional() })).optional() }).optional(),
        })).optional(),
      }).describe('Details of progress, in rich text format'),
    }),
    params: z.object({ user_id_type: z.enum(['open_id', 'union_id', 'user_id']).optional() }).optional(),
...
export const okrV1ReviewQuery = {
  ...
  schema: {
    params: z.object({
      user_id_type: z.enum(['open_id', 'union_id', 'user_id', 'people_admin_id']).optional(),
...
export const okrV1UserOkrList = {
  ...
  schema: {
    params: z.object({
      user_id_type: z.enum(['open_id', 'union_id', 'user_id', 'people_admin_id']).optional(),
      offset: z.string().describe('The offset of the request list, offset>=0'),
      limit: z.string().describe('The length of the request list, 0 < limit <= 10'),
      lang: z.string().optional(),
      period_ids: z.array(z.string()).optional(),
    }),
    path: z.object({ user_id: z.string().optional() }).optional(),
    useUAT: z.boolean().optional(),
  },
};
